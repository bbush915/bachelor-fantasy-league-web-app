<template>
  <div class="about h-full bg-gray-darkest flex flex-col items-center">
    <div class="about__overlay fixed h-full w-full" />
    ...
    <div class="max-w-4xl mb-40">
      ...
      <p>
        ...
        selecting contenstants who you think will receive a rose. You can edit
        your lineup until 8pm EST the day the episode airs. Once the episode
        airs the lineup will be locked. If you don’t set your lineup you will
        receive 0 points for that week. After the episode ends you can set your
        lineup for the following week.
      </p>
      <h2>Scoring</h2>
      <p>
        ...
        <br />
        <br />
        You will receive points for each contestant in your lineup who receives
        a rose. The number of points earned is based on the week number. In week
        1 you will earn 1 point per contestant, in week 2 you will earn 2 points
        per contestant, etc.
        <br />
        <br />
