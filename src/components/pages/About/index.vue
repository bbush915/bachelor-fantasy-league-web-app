    ...
    <div class="relative flex flex-col mx-40 mb-80">
      ...
      <div class="self-center w-2/3">
        ...
        <p>
          ...
          The person who creates the league is the League Commissioner and can invite other players
        ...
        <p>
          ...
          lineup. You set your lineup each week by selecting contenstants who you think will receive
          a rose. You can edit your lineup until 8pm EST the day the episode airs. Once the episode
          airs the lineup will be locked. If you don’t set your lineup you will receive 0 points for
        ...
        <p>
          ...
          <br />
          <br />
          You will receive points for each contestant in your lineup who receives a rose. The number
          of points earned is based on the week number. In week 1 you will earn 1 point per
